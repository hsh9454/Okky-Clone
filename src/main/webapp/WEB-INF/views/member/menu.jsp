...
<div class="nav flex-column nav-pills gap-1">
    ...
    <small class="text-muted fw-bold mb-2 px-3" style="font-size: 0.75rem;">OTHERS</small>
    <a class="nav-link link-dark" href="#">공지사항</a>
    <a class="nav-link link-dark" href="#">이벤트</a>
    <a class="nav-link link-dark" href="#">채용정보</a>
</div>