...
<div
	...
	<div
		...
		<a href="${pageContext.request.contextPath}/board/list?group=qna"
			...
			href="${pageContext.request.contextPath}/board/list?group=etc_main"
			class="nav-link text-dark fw-bold small">Jobs</a> <a href="#"
			...
			<div
				...
				<div class="menu-col">
					<h6 class="fw-bold mb-3 text-orange">
						<i class="bi bi-mortarboard-fill me-1"></i>부트캠프
					</h6>
					<ul class="list-unstyled small">
				...
				<div class="menu-col">
					<h6 class="fw-bold mb-3 text-purple">
						OKKY JOBS <i class="bi bi-box-arrow-up-right small"></i>
					</h6>
					<ul class="list-unstyled small">
