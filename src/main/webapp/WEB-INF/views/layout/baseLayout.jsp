...
.menu-col { flex: 1; padding: 0 25px; border-right: 1px solid #f1f3f5; }
.menu-col:last-child { border-right: none; }
.badge-new { font-size: 10px; background-color: #e7f5ff; color: #339af0; padding: 1px 4px; border-radius: 4px; margin-left: 4px; }
.text-orange { color: #f76707; }
.text-purple { color: #7048e8; }
.mega-dropdown-panel .dropdown-item { padding: 0.25rem 0; color: #666; font-size: 0.9rem; }
.mega-dropdown-panel .dropdown-item:hover { color: #007bff; background: none; }
</style>
</head>
<body>
    ...
    <nav class="navbar navbar-expand-lg sticky-top mb-3" style="z-index: 2000; background: #fff;">
        <div class="container" style="max-width: 1400px; position: relative;"> <tiles:insertAttribute name="header" />
        </div>
    </nav>
    ...
    <div class="okky-main-grid">
        ...
        <main class="center-content" style="z-index: 1;">
